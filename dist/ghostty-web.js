...
class W {
  ...
  encode(A) {
    ...
    if (this.exports.ghostty_wasm_free_opaque(Q), this.exports.ghostty_key_event_set_action(C, A.action), this.exports.ghostty_key_event_set_key(C, A.key), this.exports.ghostty_key_event_set_mods(C, A.mods), A.utf8) {
      const e = new TextEncoder().encode(A.utf8), a = this.exports.ghostty_wasm_alloc_u8_array(e.length);
...
class QA {
  constructor(A, Q = {}) {
    ...
    this.ctx = B, this.fontSize = Q.fontSize ?? 15, this.fontFamily = Q.fontFamily ?? "monospace", this.cursorStyle = Q.cursorStyle ?? "block", this.cursorBlink = Q.cursorBlink ?? !1, this.theme = { ...H, ...Q.theme }, this.devicePixelRatio = Q.devicePixelRatio ?? window.devicePixelRatio ?? 1, this.palette = [
      this.theme.black,
      this.theme.red,
      this.theme.green,
      this.theme.yellow,
  ...
  render(A, Q = !1, B = 0, E, C = 1) {
    ...
    (N = A.needsFullRedraw) != null && N.call(A) && (Q = !0), (this.canvas.width !== D.cols * this.metrics.width * this.devicePixelRatio || this.canvas.height !== D.rows * this.metrics.height * this.devicePixelRatio) && (this.resize(D.cols, D.rows), Q = !0), B !== this.lastViewportY && (Q = !0, this.lastViewportY = B);
  ...
  renderCellText(A, Q, B, E) {
    ...
    let k;
    if (A.grapheme_len > 0 && ((c = this.currentBuffer) != null && c.getGraphemeString) ? k = this.currentBuffer.getGraphemeString(B, Q) : k = String.fromCodePoint(A.codepoint || 32), this.ctx.fillText(k, e, a), A.flags & F.FAINT && (this.ctx.globalAlpha = 1), A.flags & F.UNDERLINE) {
    ...
    if (this.hoveredLinkRange) {
      ...
      if (B === N.startY && Q >= N.startX && (B < N.endY || Q <= N.endX) || B > N.startY && B < N.endY || B === N.endY && Q <= N.endX && (B > N.startY || Q >= N.startX)) {
        const G = I + this.metrics.baseline + 2;
        this.ctx.strokeStyle = "#4A90E2", this.ctx.lineWidth = 1, this.ctx.beginPath(), this.ctx.moveTo(C, G), this.ctx.lineTo(C + D, G), this.ctx.stroke();
      }
    }
  }
  /**
  ...
  renderCursor(A, Q) {
    ...
    switch (this.ctx.fillStyle = this.theme.cursor, this.cursorStyle) {
      case "block":
        this.ctx.fillRect(B, E, this.metrics.width, this.metrics.height);
        const I = (C = this.currentBuffer) == null ? void 0 : C.getLine(Q);
      ...
      case "bar":
        ...
        this.ctx.fillRect(B, E, o, this.metrics.height);
        break;
    }
  }
  // ==========================================================================
...
const l = class L {
  ...
  constructor(A, Q, B, E) {
    this.selectionStart = null, this.selectionEnd = null, this.isSelecting = !1, this.mouseDownTarget = null, this.mouseButtonsPressed = /* @__PURE__ */ new Set(), this.dirtySelectionRows = /* @__PURE__ */ new Set(), this.selectionChangedEmitter = new U(), this.boundMouseUpHandler = null, this.boundContextMenuHandler = null, this.boundClickHandler = null, this.boundDocumentMouseMoveHandler = null, this.autoScrollInterval = null, this.autoScrollDirection = 0, this.terminal = A, this.renderer = Q, this.wasmTerm = B, this.textarea = E, this.attachEventListeners();
  }
        ...
        if (a && a.codepoint !== 0) {
          ...
          if (a.grapheme_len > 0)
            if (D < C)
              ...
              const c = D - C;
              k = this.wasmTerm.getGraphemeString(c, e);
            }
          else
  ...
  constructor(A = {}) {
    this.unicode = {
      ...
      if (this.hasMouseTracking() && E && this.canvas && this.renderer) {
        ...
        for (let J = 0; J < N; J++)
          this.dataEmitter.fire(`\x1B[<${G};${a + 1};${k + 1}M`);
        return;
      }
