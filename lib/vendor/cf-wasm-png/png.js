//#region src/lib/png.js
var DecodeResult = class {
	__destroy_into_raw() {
...
* @returns {Uint8Array}
*/
function encode(image, width, height, palette, trns, color, depth, compression, filter) {
	const ptr0 = passArray8ToWasm0(image, wasm.__wbindgen_malloc);
	const len0 = WASM_VECTOR_LEN;
	...
	const ret = wasm.encode(ptr0, len0, width, height, ptr1, len1, ptr2, len2, isLikeNone(color) ? 16777215 : color, isLikeNone(depth) ? 16777215 : depth, isLikeNone(compression) ? 16777215 : compression, isLikeNone(filter) ? 16777215 : filter);
...
//#endregion
export { DecodeResult, decode, __wbg_init as default, encode, initSync };
